...
tags: [tool, blog-article, generator, 3-step, seo, ddd-governance]
goal: Implement the Blog Article Generator tool — 3-step workflow with hardcoded LLM model overrides, generating Italian blog articles from English input
---
