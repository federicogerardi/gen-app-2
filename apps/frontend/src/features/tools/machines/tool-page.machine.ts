...
import { hydrationMachine, type HydrationResult } from './hydration.machine';
...
import { buildReadinessSnapshot, deriveHasExtractionContext, deriveHasPrimaryTargetStep, type ReadinessSnapshot } from './tool-page-readiness';
import { buildDefaultViewModel, buildToolPageViewModel, canStartFromPolicy, type ToolPageViewModel } from './tool-page-view-model';
import { resolveFlowProgressState, type ToolPageProgressState } from './tool-page-progress';
