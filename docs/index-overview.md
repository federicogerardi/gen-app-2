...
- [admin-changelog-and-user-reporting-spec](./02-design/specifications/admin-changelog-and-user-reporting-spec.md) — **DDD-first proposal for ProductChangelog, UserReport, and FeedbackCenterMachine**
