...
| [Plan: Post-BullMQ Improvements](../05-plans/plan-post-bullmq-improvements.md) | **✅ Implementato** — RISK-5 (dev guide), RISK-4 (Zod), RISK-3 (domain modules), RISK-6 (inspector) completati (2026-07-22) |
