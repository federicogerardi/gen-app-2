...
| TASK-011B | Add deterministic retry/backoff policy for transient provider failures only (`429`, `5xx`) with bounded attempts and jitter; prohibit retries for semantic/auth failures (`401`, `403`, `404`, `422`). | ✅ | 2026-05-16 |
