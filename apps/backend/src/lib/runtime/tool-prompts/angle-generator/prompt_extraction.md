...
- Solution Aware
  ...
  Evidence from sources: ...
- Product Aware
  Nature check: the audience recognizes the product or a named comparable competitor and is still resolving trust or objection gaps; generic ad exposure or review reading alone is not enough
  Message function: resolve objections and prove product-specific credibility
  Evidence from sources: ...
- Most Aware
  Nature check: the audience has already entered a direct buying conversation such as a quote request, direct contact, proposal review, or equivalent high-intent sales interaction; comparison alone is not enough
...
- Angle: ...
  ...
  Disambiguation note: if the angle mentions ads, reviews, or generic comparison without direct buying contact, keep it at `Solution Aware`; only upgrade to `Product Aware` when the product or brand is explicitly recognized, and only upgrade to `Most Aware` when direct sales intent is explicit.
