...
- [Sprint 4 Implementation Plan - Phase 2](./sprint-4-core-architecture-resolution-implementation-plan.md) (Steps 1,4: error-actors + state documentation)
- [Unified Architectural Vulnerabilities Review](../docs/07-governance/unified-architectural-vulnerabilities-review.md)
- [Domain Bounded Context Map](../docs/02-design/domain-bounded-context-map.md) (BCM L40)
