...
const PROMPT_FILE_BY_KEY = {
  ...
  'youtube-lf-script:extraction': 'src/lib/runtime/tool-prompts/youtube_lf_script/youtube-lf-script-extraction.md',
  ...
  'youtube-lf-script:pre-script-analysis':
    'src/lib/runtime/tool-prompts/youtube_lf_script/youtube-lf-script-pre-script-analysis.md',
  'youtube-lf-script:packaging': 'src/lib/runtime/tool-prompts/youtube_lf_script/youtube-lf-script-packaging.md',
  'youtube-lf-script:intro-structure':
    'src/lib/runtime/tool-prompts/youtube_lf_script/youtube-lf-script-intro-structure.md',
  'youtube-lf-script:body-structure':
    'src/lib/runtime/tool-prompts/youtube_lf_script/youtube-lf-script-body-structure.md',
  'youtube-lf-script:native-cta-embeds':
    'src/lib/runtime/tool-prompts/youtube_lf_script/youtube-lf-script-native-cta-embeds.md',
  'youtube-lf-script:outro-structure':
    'src/lib/runtime/tool-prompts/youtube_lf_script/youtube-lf-script-outro-structure.md',
} as const;
