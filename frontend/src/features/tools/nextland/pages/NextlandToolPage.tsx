...
export const NextlandToolPage = () => {
  ...
  const [prompt, setPrompt] = useState('Genera lo step Nextland richiesto con coerenza al brief estratto.');
  ...
  const runNextStep = (): void => {
    ...
    const request = createStepRequest(baseRequest, 'nextland', nextStep, dependencies);
