# Graph Report - gen-app-2  (2026-07-07)

## Corpus Check
- 616 files · ~431,694 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5895 nodes · 10830 edges · 520 communities (274 shown, 246 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 54 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `360b6f60`
...
- [[_COMMUNITY_Usage Repository Test|Usage Repository Test]]
...
- [[_COMMUNITY_Introduction|Introduction]]
- [[_COMMUNITY_Analysis Plan Isolated Nodes Investigation|Analysis Plan: Isolated Nodes Investigation]]
...
- [[_COMMUNITY_1. Categorization Framework|1. Categorization Framework]]
- [[_COMMUNITY_4. Expected Outputs|4. Expected Outputs]]
- [[_COMMUNITY_5b. Investigation Results (2026-07-07)|5b. Investigation Results (2026-07-07)]]
- [[_COMMUNITY_Test Categories|Test Categories]]
- [[_COMMUNITY_Current State Analysis|Current State Analysis]]
...
- [[_COMMUNITY_Phase 3 Execution Notes|Phase 3 Execution Notes]]
...
- `normalizeToolWorkflowKey()` --calls--> `isToolWorkflowType()`  [EXTRACTED]
  apps/backend/src/lib/runtime/workflow-normalizers.ts → packages/contracts/src/tool-workflows.ts

## Import Cycles
- None detected.

## Communities (520 total, 246 thin omitted)

### Community 0 - "Adapters Auth Interfaces"
Cohesion: 0.06
Nodes (47): AuthRepositoryBundle, AuthSessionRepository, AuthUserRepository, OAuthStateRepository, AuthProductionClients, AuthSessionJoinRow, AuthUserRow, mapAuthSessionPrincipalRow() (+39 more)
...
Cohesion: 0.08
Nodes (23): ArtifactRecord, IdempotencyRecord, LlmGenerateAdapter, LlmGenerateInput, LlmGenerateResult, LlmStreamEvent, LlmStreamInput, OwnershipAdapter (+15 more)

### Community 3 - "Extraction Chain Machine"
Cohesion: 0.04
Nodes (73): GenerationAdapters, OrchestrateArtifactCache, extractionChainMachine, ExtractionChainMachineContext, ExtractionChainMachineEvent, ExtractionChainMachineInput, AcquisitionChainContext, AcquisitionChainInput (+65 more)

### Community 4 - "User Reports Constants"
Cohesion: 0.06
Nodes (86): buildApiPaths(), resolveBackendCapabilities(), isHttpClientError(), joinApiPath(), AdminApiServiceBindingsEnvelope, AdminApiServicesEnvelope, AdminClientOptions, AdminUsersResponse (+78 more)
...
Cohesion: 0.09
Nodes (20): AuthProductionOptions, createKyselyDb(), ApiServicesTable, ApiServiceToolStepBindingsTable, ArtifactsTable, AuthSessionsTable, DB, LlmModelsTable (+12 more)

### Community 7 - "Upload Machine Briefinguploadmachine"
Cohesion: 0.11
Nodes (34): briefingUploadMachine, hasReadyBriefingExtractionContext(), assertCompleteHydrationResult(), hydrateExtractionContext(), hydrationMachine, HydrationMachineInput, HydrationMachineOutput, HydrationResult (+26 more)

### Community 8 - "Generation System Actions"
Cohesion: 0.07
Nodes (50): GenerationActionArgs, GenerationAssignment, GenerationCollectActions, GenerationSystemActionObject, GenerationSystemGuardObject, GenerationSystemProvidedActor, getAcquisitionDoneOutput(), getAcquisitionResultParams() (+42 more)

### Community 9 - "Config Stream Config"
Cohesion: 0.07
Nodes (35): FrontendGenerationContext, FrontendGenerationEvent, FrontendGenerationInput, frontendGenerationMachine, FrontendGenerationStatus, ExtractionContext, FrontendStreamContext, FrontendStreamEvent (+27 more)

### Community 10 - "Auth Interfaces Authrepositorybundle"
Cohesion: 0.05
Nodes (74): PasswordHashRuntime, AdminFeedbackCenterHandlers, createAdminHandlers(), CreateAdminHandlersDependencies, AdminLlmModelHandlers, AdminUserHandlers, createAdminUserHandlers(), CreateAdminUserHandlersDependencies (+66 more)

### Community 11 - "Runtime Auth Contract"
Cohesion: 0.07
Nodes (37): generateRequestId(), isAllowedBriefingExtension(), GenerationTransportError, isTopLevelArrayJson(), parseExtractionArtifactContent(), readExtractionPayloadFromArtifact(), BriefingUploadContext, BriefingUploadEvent (+29 more)
...
Cohesion: 0.08
Nodes (28): AuthSessionContext, AuthSessionEvent, AuthSessionInput, authSessionMachine, LoginInput, LogoutInput, ReadSessionInput, FAKE_SESSION (+20 more)

### Community 14 - "Shared Utils Readinputfield"
Cohesion: 0.07
Nodes (28): STREAM_CONFIG, FrontendStreamStatus, FrontendGenerationSnapshot, FrontendStreamEvent, FrontendStreamSend, FrontendStreamSnapshot, GenerationArtifactsWorkspaceContext, GenerationGenerationWorkspaceContext (+20 more)
...
Cohesion: 0.12
Nodes (26): ApiServiceValidationInput, isPlainRecord(), MAPPING_RULE_RESERVED_RUNTIME_KEYS, toApiServiceRedactedDto(), ToolStepBindingValidationInput, validateApiServiceInput(), validateErrorMappingRules(), validatePath() (+18 more)
...
Cohesion: 0.06
Nodes (49): appCopy, formatMeta(), ApiPaths, BackendCapabilities, defaultBackendCapabilities, UseAdminModelsQueryOptions, UseAdminUsersQueryOptions, UseArtifactDetailQueryOptions (+41 more)

### Community 19 - "Meta Ads Evolution"
Cohesion: 0.16
Nodes (16): createSyntheticLlmGenerateAdapter(), createSyntheticLlmStreamAdapter(), LlmStreamAdapter, OwnershipDecision, createPostgresRedisGenerationAdapters(), PostgresRedisAdapterDependencies, ProjectOwnershipRepository, createPostgresRedisProductionDependencies() (+8 more)
...
Cohesion: 0.03
Nodes (75): createAuthStubRepositories(), createInMemoryGenerationAdapters(), StubArtifactQueryRecord, AuthIdGenerator, AuthRuntimeContracts, CookieSameSite, createDefaultAuthIdGenerator(), createDefaultPasswordHashRuntime() (+67 more)
...
Cohesion: 0.04
Nodes (103): UI_CONFIG, CopyOption, AuthenticatedShell(), MainNavigation(), MainNavigationProps, NavIcon, navIcons, PublicShell() (+95 more)

### Community 24 - "Src Api Service"
Cohesion: 0.06
Nodes (57): ExtractionFieldLabelByKey, mapExtractionFieldKeysToLabels(), mapExtractionFieldKeyToLabel(), ApiAcquisitionRequest, ApiAcquisitionResult, ApiServiceAccessMode, ApiServiceBindingRequiredness, ApiServiceBindingStatus (+49 more)
...
Cohesion: 0.12
Nodes (33): normalizeIdentifier(), readJsonBody(), ArtifactFilterCriteria, belongsToTool(), buildExtractionContextFromArtifact(), buildLatestArtifactByStep(), collectCompletedRunSteps(), collectCompletedStepsBySession() (+25 more)

### Community 27 - "Pages Adminapiservicespage Test"
Cohesion: 0.08
Nodes (35): apiServicesDb, bindingsDb, feedbackApiSpy, TestApiService, TestBinding, AdminChangelogPage(), feedbackApiSpy, feedbackApiSpy (+27 more)
...
Cohesion: 0.15
Nodes (13): buildMessage(), FeedbackMessageAction, FeedbackMessageContext, FeedbackMessageContextValue, FeedbackMessageProvider(), feedbackMessageReducer(), FeedbackMessageState, FeedbackSeverity (+5 more)

### Community 34 - "System User Guide"
Cohesion: 0.13
Nodes (14): AdminApiServiceCreateBody, adminApiServiceCreateSchema, AdminApiServiceHandlers, AdminApiServiceUpdateBody, adminApiServiceUpdateSchema, apiServiceAccessModeSchema, apiServiceRequestMethodSchema, apiServiceStatusSchema (+6 more)
...
Cohesion: 0.11
Nodes (32): ARTIFACT_FAILURE_REASONS, ARTIFACT_STATUS_TRANSITIONS, ArtifactFailureReason, canTransitionArtifactStatus(), CONTRACT_TOOL_WORKFLOWS, isArtifactFailureReason(), isArtifactStatus(), isOutputFormat() (+24 more)

### Community 38 - "App Copy System"
Cohesion: 0.13
Nodes (13): 0. Phase 0 - Initial DDD Analysis for Meta Ads Evolution, 10. Dependencies, 13. Related Specifications, 1. Scope, 2. Session Entry Gate, 2b. Deterministic Inputs (Mandatory), 9.1 Technical Risks, 9.2 Business Risks (+5 more)

### Community 39 - "Copy System Appcopy"
Cohesion: 0.16
Nodes (24): useAdminUsersQuery(), AdminUsersPage(), AdminUser, ADMIN_USER_ROLE_OPTIONS, ADMIN_USER_STATUS_OPTIONS, adminUserFormSchema, AdminUserFormValues, createEditUserForm() (+16 more)

### Community 40 - "Queries Useartifactdetailquery Useartifactdetailquery"
Cohesion: 0.10
Nodes (32): generateSessionId(), readInputField(), GenerationArtifactsWorkspaceValue, useGenerationArtifactsWorkspace(), useGenerationGenerationWorkspace(), useGenerationProjectWorkspace(), useGenerationStreamWorkspace(), useRequiredContext() (+24 more)

### Community 41 - "Ui Listingtablesection Listingtablesection"
Cohesion: 0.14
Nodes (20): AdminUserReportsPage(), ReportsTable(), ReportsTableProps, USER_REPORT_COLUMNS, formatAdminDateTime(), USER_REPORT_CATEGORY_FILTER_OPTIONS, USER_REPORT_STATUS_FILTER_OPTIONS, canPublishUserReportIssue() (+12 more)
...
Cohesion: 0.15
Nodes (10): authState, availableStepsState, briefingMachineSeed, briefingState, extractionContextState, generationRunWorkspaceState, generationState, generationWorkspaceState (+2 more)
...
Cohesion: 0.13
Nodes (13): StreamAdapter, ProductionAdapterRuntime, RedisStreamSessionRepository, ArtifactRow, IdempotencyRow, OrchestrateCacheOptions, ProjectRow, StreamRepositoryOptions (+5 more)

### Community 47 - "Queries Useadminmodelsquery Useadminmodelsquery"
Cohesion: 0.11
Nodes (26): HttpClientError, HttpClientRequestError, isHttpDebugEnabled(), isRetryableStatus(), logHttpDebug(), parseJsonSafely(), requestJson(), RequestJsonOptions (+18 more)

### Community 48 - "Auth Production Createauthproductionrepositories"
Cohesion: 0.10
Nodes (24): createModel(), deleteModel(), getDb(), _kyselyDbCache, listAllModels(), listEnabledModels(), updateModel(), createAdminLlmModelHandlers() (+16 more)

### Community 49 - "Form Architecture Gettoolapiacquisitionpolicy"
Cohesion: 0.10
Nodes (39): getToolApiAcquisitionPolicy(), createStepRequest(), DispatchErrorReasonCode, isEmptyPayload(), mapInlineDispatchError(), mapReasonCodeToMessage(), normalizeModelForPayload(), normalizeToDispatchErrorReasonCode() (+31 more)

### Community 50 - "10 Acceptance Gates"
Cohesion: 0.40
Nodes (7): GlobalFeedbackMessage, Probe(), useFeedbackMessage(), getAlertRole(), getAriaLiveMode(), GlobalFeedbackViewport(), Publisher()
...
Cohesion: 0.12
Nodes (16): APPENDICE: NUOVI PROMPT DI SOSTITUZIONE, Architettura Tecnica Attuale, Caratteristiche Long-Form (Predefinito), CONCLUSIONI, EXECUTIVE SUMMARY, IMPATTO TECNICO, Modifiche Richieste, NUOVA VISIONE PROPOSTA (+8 more)
...
Cohesion: 0.22
Nodes (9): 2. Implementation Steps, Implementation Phase 0, Implementation Phase 1, Implementation Phase 2, Implementation Phase 3, Implementation Phase 4, Implementation Phase 5, Implementation Phase 6 (+1 more)
...
Cohesion: 0.05
Nodes (67): archiveProductChangelog(), createProductChangelog(), getDb(), _kyselyDbCache, listProductChangelogs(), listPublishedProductChangelogs(), publishProductChangelog(), createUserReport() (+59 more)

### Community 59 - "Prompt Vsl Generator"
Cohesion: 0.22
Nodes (9): Analysis Plan: Documentation Linking, Context, Current State, Execution Checklist, Expected Outcome, Format, Proposed Approach, References (+1 more)

### Community 60 - "Tool Form Architecture"
Cohesion: 0.11
Nodes (19): getEnabledToolKeys(), getEnabledToolNavigationItems(), isToolEnabled(), StepCardConfig, stepCardConfigRegistry, ToolApiAcquisitionPolicyEntry, ToolFileInstructionsConfig, toolFileInstructionsRegistry (+11 more)

### Community 61 - "System Actions Generationsystemactions"
Cohesion: 0.08
Nodes (25): PostgresRedisProductionClients, PostgresRedisProductionOptions, generationSystemActions, generationSystemActors, generationSystemMachine, getFallbackDoneOutput(), generationSystemGuards, ContextArgs (+17 more)

### Community 62 - "Admin Pages Adminapiservicespage"
Cohesion: 0.07
Nodes (49): AdminApiServicesPage(), toBindingInput(), toCreateInput(), toUpdateInput(), adminApiServiceBindingFormSchema, AdminApiServiceBindingFormValues, createEditAdminApiServiceBindingForm(), createEmptyAdminApiServiceBindingForm() (+41 more)

### Community 63 - "Runtime Queries Useartifactsquery"
Cohesion: 0.17
Nodes (17): applyQuery(), ArtifactsClientOptions, ArtifactsResponse, BackendArtifact, listArtifacts(), listArtifactsPaginated(), ListArtifactsResult, normalizeModelId() (+9 more)

### Community 64 - "Tool Ux State"
Cohesion: 0.03
Nodes (76): useArtifactDetailQuery(), CtaButtonProps, PrimaryCtaButton(), SecondaryCtaButton(), SoftCtaButton(), UploadFieldButton(), UploadFieldButtonProps, ArtifactDetailPage() (+68 more)

### Community 65 - "Auth Interfaces Userqueryrepositorybundle"
Cohesion: 0.18
Nodes (11): PostgresProjectQueryRepository, ProjectQueryRepository, createRandomId(), ProjectQueryRepositoryStub, CreateProjectInput, mapProjectRowToDetail(), mapProjectRowToSummary(), ProjectDetail (+3 more)
...
Cohesion: 0.33
Nodes (6): 1. **Maggiore Precisione di Target**, 2. **Flessibilità Operativa**, 3. **Performance Meta Ads Superiore**, 4. **Scalabilità Organizzativa**, 5. **ROI Misurabile**, VANTAGGI STRATEGICI

### Community 78 - "1 Requirements Constraints"
Cohesion: 0.40
Nodes (5): FASE 1: Foundation + User Control (Sprint 1-2), FASE 2: Core Development (Sprint 3-5), FASE 3: Quality & Scale (Sprint 6-7), FASE 4: Launch & Optimize (Sprint 8), ROADMAP IMPLEMENTAZIONE
...
Cohesion: 0.09
Nodes (33): BackendJsonSessionResult, BackendSessionResult, runBackendGenerationSession(), runBackendGenerationSessionAsJson(), RunBackendGenerationSessionOptions, BackendError, BackendErrorCode, mapFailureReasonToBackendError() (+25 more)
...
Cohesion: 0.40
Nodes (5): 4. Implementation Steps, Phase 1: Foundation + User Control (Sprint 1-2), Phase 2: Core Prompt System (Sprint 3-5), Phase 3: Frontend Navigation & UI (Sprint 6-7), Phase 4: Quality Assurance & Launch (Sprint 8)
...
Cohesion: 0.40
Nodes (5): 7.1 Unit Tests, 7.2 Integration Tests, 7.3 Performance Tests, 7.4 User Acceptance Tests, 7. Testing Strategy

### Community 86 - "Redis Cache 1"
Cohesion: 0.50
Nodes (4): Backend Prompt Integration, Contracts Update, CONTROLLO LUNGHEZZA COPY - SPECIFICA TECNICA, Input Form - Nuova Sezione
...
Cohesion: 0.50
Nodes (4): Backward Compatibility, Implementazione Prompt, Modifiche ai File Esistenti, Variabili Template

### Community 89 - "Stream Logger Ts"
Cohesion: 0.50
Nodes (4): KPI Operativi, KPI Primari (per formato lunghezza), KPI Tecnici, METRICHE DI SUCCESSO

### Community 90 - "New Tool Characteristics"
Cohesion: 0.50
Nodes (4): 11. Files Modified/Created, Backend Files, Documentation Files, Frontend Files
...
Cohesion: 0.17
Nodes (27): createApiService(), CreateApiServiceInput, deleteApiService(), deleteApiServiceBinding(), getApiServiceById(), getDb(), _kyselyDbCache, listApiServiceBindings() (+19 more)

### Community 93 - "Generation Adapters Idempotencyadapter"
Cohesion: 0.20
Nodes (6): IdempotencyAdapter, IdempotencyDecision, PostgresRedisIdempotencyRepository, RedisIdempotencyRepository, RedisIdempotencyRepositoryStub, IdempotencyCoordinatorInput

### Community 94 - "Prompt Unified Report"
Cohesion: 0.50
Nodes (4): 12.1 Week 1-2: Launch Monitoring, 12.2 Month 1: Performance Analysis, 12.3 Month 3: Optimization & Iteration, 12. Post-Launch Monitoring

### Community 95 - "Script Prompt Extraction"
Cohesion: 0.50
Nodes (4): 3. End-to-End Flow Under Plan, Phase A - Requirements to Enhanced Tool Definition, Phase B - Backend Runtime Path Enhancement, Phase C - Frontend Tool Workspace Path Enhancement

### Community 96 - "Plans And Runbooks"
Cohesion: 0.50
Nodes (4): 5.1 Contract Extensions, 5.2 Frontend Component Architecture - Percorsi Corretti, 5.3 Prompt Template Variables, 5. Technical Implementation Details

### Community 97 - "Backend Adapters 1"
Cohesion: 0.50
Nodes (4): 8.1 Performance KPIs, 8.2 Business KPIs, 8.3 Technical KPIs, 8. Success Metrics
...
Cohesion: 0.10
Nodes (30): UserQueryRepositoryBundle, createProjectRequestSchema, createProjectsHandlers(), CreateProjectsHandlersDependencies, parseArtifactReadProjection(), parseBooleanQueryFlag(), WriteError, WriteSuccess (+22 more)
...
Cohesion: 0.67
Nodes (3): Backend Validation, DETTAGLIO IMPLEMENTAZIONE CONTROLLO LUNGHEZZA, Frontend Implementation

### Community 103 - "Blocker Removal 1"
Cohesion: 0.67
Nodes (3): 6.1 Feature Flag Implementation, 6.2 Migration Path, 6. Backward Compatibility Strategy
...
Cohesion: 0.15
Nodes (18): createAuthProductionRepositories(), createNodeRuntimeServer(), getAllOverrides(), getStepOverride(), STEP_LLM_MODEL_OVERRIDES, createStepLlmModelResolver(), StepLlmModelResolver, StepLlmModelResolverImpl (+10 more)
...
### Community 190 - "Auth Production Nowdate"
Cohesion: 0.12
...
Cohesion: 0.11
Nodes (18): 1. Requirements & Constraints, 2b. Prompt Specifications (Deterministic), 2c. XState Runtime Contract (Deterministic), 2d. PAA Discovery Flow (Deterministic), 3. Alternatives, 4. Dependencies, 5. Files, 6. Testing (+10 more)
...
### Community 214 - "Usage Repository Test"
Cohesion: 0.14
...
### Community 221 - "E2E Test Mockserverresponse"
Cohesion: 0.14
...
### Community 223 - "Orchestrate Test Orchestrateartifactcachestub"
Cohesion: 0.08
...
### Community 239 - "App Ui Uploadfieldbutton"
Cohesion: 0.08
...
### Community 367 - "Production Observability Runbook"
Cohesion: 0.08
...
### Community 470 - "Fase 2 — Fix Strutturale: Redis Artifact Cache"
Cohesion: 0.09
...
### Community 483 - "Refactor: API Service DDD Blocker Removal Plan"
Cohesion: 0.11
...
### Community 502 - "Introduction"
Cohesion: 0.12
Nodes (15): 1. Requirements & Constraints, 2. Implementation Steps, 3. Alternatives, 4. Dependencies, 5. Files, 6. Testing, 7. Risks & Assumptions, 8. Related Specifications / Further Reading (+7 more)

### Community 503 - "Phase 1: Backend — Adapter + Actor + Endpoint"
Cohesion: 0.12
...
### Community 518 - "Plan: Add Non-Streaming Generation Mode (Coexistence)"
Cohesion: 0.15
...
### Community 519 - "Refactoring Plan: Admin Handlers Cohesion"
Cohesion: 0.15
Nodes (13): Alternative: Extract Handler Factories, Approach: Subdirectory Decomposition (Non-Breaking), Context, DDD Validation (2026-07-07), Execution Checklist, Expected Outcome, Phase 1 — Analysis (this plan), Phase 2 — Implementation (2026-07-07) (+5 more)

### Community 520 - "1. Module Fragmentation & Documentation Graph Disconnection (INVESTIGATED)"
Cohesion: 0.17
Nodes (12): 1. Module Fragmentation & Documentation Graph Disconnection (INVESTIGATED), 2. Low Modular Cohesion ("Feature Envy") — PARTIALLY ADDRESSED, 3. Overloaded Domain "God Nodes", 4. Circular Dependencies (RESOLVED), Categorization of 2517 Non-Main Nodes, Component Topology, Executive Summary, Key Areas for Intervention (+4 more)
...
Cohesion: 0.07
Nodes (27): API Consumption, Architecture, Common Issues, Common Scenarios, Configuration, Data Mapping, Database Setup, DDD Alignment (+19 more)
...
### Community 529 - "ADR-003: XState Explicit Error States Pattern"
Cohesion: 0.18
...
### Community 540 - "Phase 2: Frontend — Client + Machine + Default"
Cohesion: 0.20
...
### Community 541 - "LLM Model Step Override System - Implementation Plan"
Cohesion: 0.20
...
### Community 546 - "Analysis Plan: Isolated Nodes Investigation"
Cohesion: 0.15
Nodes (13): 0. Phase 0 - Graphify Query Strategy, 2. Investigation Phases, 3. Execution Commands, 5. Success Criteria, 6. Risk Mitigation, 7. References, Analysis Plan: Isolated Nodes Investigation, Context (+5 more)

### Community 547 - "3. Implementation Phases"
Cohesion: 0.22
Nodes (9): 1.1 Static Configuration System (1 day), 1.2 Model Resolution Service (1.5 days), 1.3 Startup Validation (0.5 days), 2.1 Artifact Metadata Enhancement (1.5 days), 2.2 Generation Request Processing (1 day), 2.3 Step Key Extraction (0.5 days), 3. Implementation Phases, Phase 1: Backend Foundation (2-3 days) (+1 more)
...
### Community 559 - "Fix Attempts & Evidence"
Cohesion: 0.25
...
### Community 561 - "High Priority Risks"
Cohesion: 0.25
...
Cohesion: 0.17
Nodes (12): Aliases And Deprecated Terms, Auth Context, Canonical Terms, Competitor Analysis Context, Crawling & Extraction Context, Cross-Context Concepts, Domain Ubiquitous Language Glossary, Evidence Anchors (+4 more)
...
### Community 569 - "9. Implementation Checklist"
Cohesion: 0.29
...
### Community 575 - "2. Implementation Steps"
Cohesion: 0.33
...
### Community 576 - "Wave 2 Instance: AdminApiServiceBindingHandlers"
Cohesion: 0.33
...
### Community 577 - "Wave 2 Checklist Template"
Cohesion: 0.33
...
### Community 583 - "9. Completion Summary"
Cohesion: 0.40
Nodes (5): 9. Completion Summary, Executed Changes, Key Fixes During Execution, Notes, Validation Results

### Community 584 - "1. Categorization Framework"
Cohesion: 0.40
Nodes (5): 1. Categorization Framework, Category A: Business Logic Orphans (HIGH PRIORITY), Category B: Infrastructure Isolation (MEDIUM PRIORITY), Category C: Test/Documentation Drift (LOW PRIORITY), Category D: Dead Code Candidates (CLEANUP)

### Community 585 - "4. Expected Outputs"
Cohesion: 0.40
Nodes (5): 4. Expected Outputs, OUT-001: Component Analysis Summary, OUT-002: Categorized Node Inventory, OUT-003: Integration Strategy, OUT-004: Graph Health Metrics Post-Integration

### Community 586 - "5b. Investigation Results (2026-07-07)"
Cohesion: 0.40
Nodes (5): 5b. Investigation Results (2026-07-07), Categorization of 2517 Non-Main Nodes, Component Topology, Key Findings, Risk Validation

### Community 587 - "Test Categories"
Cohesion: 0.40
Nodes (5): 4. Testing Strategy, Integration Tests, Manual Testing, Test Categories, Unit Tests

### Community 588 - "Current State Analysis"
Cohesion: 0.40
Nodes (5): Community Composition (83 nodes), Current State Analysis, External Coupling Hotspots, File Inventory, Root Cause of Low Cohesion
...
### Community 597 - "Phase 4 Execution Notes"
Cohesion: 0.50
...
### Community 611 - "5. Deployment Strategy"
Cohesion: 0.50
...
### Community 621 - "Phase 3 Execution Notes"
Cohesion: 0.67
Nodes (3): Explicit Wave 1 Non-Goals, Phase 3 Execution Notes, Residual Wave 2 Queue

### Community 622 - "10. Configuration Examples"
Cohesion: 0.67
Nodes (3): 10. Configuration Examples, Future Tool Override Example, Session Detail Display Example

## Knowledge Gaps
- **2967 isolated node(s):** `validate-docs-frontmatter.sh script`, `$schema`, `plugin`, `@opencode-ai/plugin`, `name` (+2962 more)
...
- **Why does `ToolKey` connect `Queries Useartifactdetailquery Useartifactdetailquery` to `Generator Pages Anglegeneratortoolpage`, `Tools Ui Toolpagetemplate`, `Tool Ux State`, `Generation Extraction Parsers`, `Http Projects Handlers`, `Upload Machine Briefinguploadmachine`, `Runtime Auth Contract`, `Session Artifact Group`, `Shared Utils Readinputfield`, `Package`, `Form Architecture Gettoolapiacquisitionpolicy`, `Tool Prompts Index`, `App Layouts Authenticatedshell`, `Src Api Service`, `Runtime Shared Utils`, `Tool Form Architecture`, `Auth Production Nowdate`, `Runtime Queries Useartifactsquery`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `appCopy` connect `Runtime Api Paths` to `Tool Ux State`, `User Reports Constants`, `Copy System Appcopy`, `Queries Useartifactdetailquery Useartifactdetailquery`, `Ui Listingtablesection Listingtablesection`, `Runtime Auth Contract`, `Session Artifact Group`, `Queries Useadminmodelsquery Useadminmodelsquery`, `Package`, `Form Architecture Gettoolapiacquisitionpolicy`, `App Layouts Authenticatedshell`, `Pages Adminapiservicespage Test`, `Tool Form Architecture`, `Admin Pages Adminapiservicespage`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `ArtifactType` connect `Artifact Types Test` to `Src Api Service`, `Runtime Shared Utils`, `Extraction Chain Machine`, `Http Projects Handlers`?**
