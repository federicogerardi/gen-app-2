...
export const uiPrimitives = {
  ...
  radioRow: 'ui-radio-row',
  radioLabel: 'ui-radio-label',
  radioDescription: 'ui-radio-description',
  badge: 'ui-badge',
  ...
  artifactTableWrap: 'ui-artifact-table-wrap',
  artifactTable: 'ui-artifact-table',
  artifactTablePagination: 'ui-artifact-table-pagination',
  artifactTableActionLink: 'ui-artifact-table-action-link',
  paginationControl: 'ui-pagination-control',
  paginationPage: 'ui-pagination-page',
